      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          <div className="flex items-center gap-3">
            ...
            <Image src="/logos/creation-os-wordmark.svg" alt="Creation OS" width={120} height={28} />
            <span className="text-xs text-muted-foreground">© {new Date().getFullYear()} Creation OS</span>
          </div>
