...
export function HeroDusk() {
  ...
  <div className="pointer-events-none absolute -bottom-40 -right-40 h-[28rem] w-[28rem] rounded-full bg-[hsl(var(--creation-os-violet))]/30 blur-[100px]" />
  ...
  <div className="container relative z-10 mx-auto px-4 py-24 text-center">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
          <Link href="/dashboard">
            <Button size="lg" className="btn-creation-os text-base md:text-lg px-7 md:px-8 py-4">
    ...
    <div className="mx-auto mt-10 max-w-5xl">
      ...
      <div className="absolute -inset-6 rounded-3xl bg-gradient-to-tr from-cyan-500/20 to-purple-500/20 blur-2xl" />
            <div className="relative overflow-hidden rounded-2xl ring-1 ring-white/10 shadow-2xl">
              <Image src={heroSrc} alt="Creation OS – tumma hero, abstrakti verkko ja brändisäteet" className="w-full h-auto object-cover" width={1600} height={900} priority />
            </div>
          </div>
        </div>
      </div>
