    ...
    background: (
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="flex items-center gap-5 md:gap-6 opacity-90">
          <Image src="/logos/openai.svg" alt="OpenAI" width={24} height={24} className="h-6 w-auto object-contain" />
          <Image src="/logos/google.svg" alt="Google" width={24} height={24} className="h-6 w-auto object-contain" />
          <Image src="/logos/anthropic.svg" alt="Anthropic" width={24} height={24} className="h-6 w-auto object-contain" />
          <Image src="/logos/microsoft.svg" alt="Microsoft" width={24} height={24} className="h-6 w-auto object-contain" />
          <Image src="/logos/github.svg" alt="GitHub" width={24} height={24} className="h-6 w-auto object-contain" />
          <Image src="/logos/figma.svg" alt="Figma" width={24} height={24} className="h-6 w-auto object-contain" />
        </div>
      </div>
    ),
  },
