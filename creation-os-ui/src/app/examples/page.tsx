  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-muted-foreground">Käytännön esimerkkejä ja mallipohjia Creation OS -komponenteilla</p>
      </div>
          ...
          <CardContent>
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">matti@creationos.local</p>
              </div>
              <Badge>Pro</Badge>
            </div>
