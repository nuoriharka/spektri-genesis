  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-xl text-muted-foreground">Kaikki mitä tarvitset Creation OS:n käyttöön</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <Card className="card-premium">
          <CardHeader>
            ...
            <CardDescription>Nopea aloitus Creation OS:n käyttöön</CardDescription>
          </CardHeader>
        ...
        <Card className="card-premium">
          ...
          <CardContent className="space-y-4">
            ...
            <Button variant="outline" asChild>
              <a href="https://github.com/lauri-elias-rainio/creation-os" target="_blank" rel="noreferrer">Selaa GitHubissa</a>
            </Button>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="mt-8 p-6 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-lg">
        ...
        <div className="flex flex-wrap gap-3">
          <Button className="btn-creation-os">Liity Discordiin</Button>
          <Button variant="outline" asChild>
            <a href="https://github.com/lauri-elias-rainio/creation-os" target="_blank" rel="noreferrer">GitHub</a>
          </Button>
