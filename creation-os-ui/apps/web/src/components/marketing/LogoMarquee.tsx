      ...
      <div className="mt-6 overflow-hidden">
        <div className="flex animate-[marquee_25s_linear_infinite] gap-10 md:gap-14 whitespace-nowrap px-4 items-center">
          <div className="h-10 md:h-12 flex items-center opacity-80">
            <Image src="/brand/creation-os-logomark-gradient.svg" alt="Creation OS" width={140} height={20} className="h-8 md:h-9 w-auto object-contain" />
            <span className="sr-only">Creation OS</span>
          </div>
          {[{ alt: "Creation OS", src: "/brand/creation-os-logomark-gradient.svg" }, ...logos, ...logos].map((l,i)=>(
