    ...
    <div className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <div className="flex items-center justify-between">
          ...
          <a href="/chat" className="text-xs text-zinc-500 hover:text-zinc-200">Open Chat</a>
        </div>
        <div className="mt-6 grid grid-cols-2 gap-2 text-xs text-zinc-500 md:grid-cols-4">
          <a href="/projects" className="border border-[#111] px-3 py-2 hover:text-zinc-200">Projects</a>
          <a href="/actions" className="border border-[#111] px-3 py-2 hover:text-zinc-200">Actions</a>
          <a href="/operations" className="border border-[#111] px-3 py-2 hover:text-zinc-200">Operations</a>
          <a href="/assets" className="border border-[#111] px-3 py-2 hover:text-zinc-200">Assets</a>
          <a href="/system" className="border border-[#111] px-3 py-2 hover:text-zinc-200">System</a>
          <a href="/status" className="border border-[#111] px-3 py-2 hover:text-zinc-200">Status</a>
          <a href="/chat" className="border border-[#111] px-3 py-2 hover:text-zinc-200">Chat</a>
          <a href="/" className="border border-[#111] px-3 py-2 hover:text-zinc-200">Dashboard</a>
        </div>
