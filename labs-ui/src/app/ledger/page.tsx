  ...
  return (
    <div className="min-h-screen bg-black text-white px-6 py-16">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-2 text-sm text-zinc-400">Live integrity snapshot.</p>
        <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="rounded-lg border border-[#111] bg-black p-6">
            <div className="text-[11px] text-zinc-500">Total Transitions</div>
            <div className="mt-2 text-3xl font-semibold text-white">{data.resonance}</div>
          </div>
        </div>
      </div>
    </div>
